...
namespace SportAcademy.Infrastructure.Persistence.Repositories
{
    public class TraineeRepository : BaseRepository<Trainee, int>, ITraineeRepository
    {
        ...
        public new async Task<TraineeDetailsDto> GetByIdAsync(int id, CancellationToken cancellationToken)
            => await _context.Trainees
                .Where(t => t.Id == id)
                .AsNoTracking()
        ...
        public async Task<List<TraineeDropdownDto>> GetDropdownAsync(CancellationToken cancellationToken = default)
            => await _context.Trainees
                .Where(t => !t.IsDeleted)
